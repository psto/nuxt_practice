        ...
        <form action method="post" @submit.prevent="submitForm()">
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model="email"
            />
            <div class="invalid-feedback" v-if="errors && errors.email">{{ errors.email.msg }}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model="password"
            />
            <div class="invalid-feedback" v-if="errors && errors.password">{{ errors.password.msg }}</div>
          </div>
