        ...
        <form action method="post" @submit.prevent="submitForm()">
          <div class="form-group">
            ...
            <input
              ...
              v-model="title"
            />
            <div class="invalid-feedback" v-if="errors && errors.title">{{ errors.title.msg }}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <input
              ...
              v-model="author"
            />
            <div class="invalid-feedback" v-if="errors && errors.author">{{ errors.author.msg }}</div>
          </div>
          ...
          <div class="form-group">
            ...
            <textarea
              ...
              v-model="body"
            ></textarea>
            <div class="invalid-feedback" v-if="errors && errors.body">{{ errors.body.msg }}</div>
          </div>
